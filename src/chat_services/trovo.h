...
class Trovo : public ChatService
{
    Q_OBJECT
public:
    explicit Trovo(ChatHandler& manager, QSettings& settings, const QString& settingsGroupPathParent, QNetworkAccessManager& network, cweqt::Manager& web, QObject *parent = nullptr);
