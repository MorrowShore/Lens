...
class GoodGame : public ChatService
{
    Q_OBJECT
public:
    explicit GoodGame(ChatManager& manager, QSettings& settings, const QString& settingsGroupPathParent, QNetworkAccessManager& network, cweqt::Manager& web, QObject *parent = nullptr);
