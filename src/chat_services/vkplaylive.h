...
class VkPlayLive : public ChatService
{
    Q_OBJECT
public:
    explicit VkPlayLive(ChatManager& manager, QSettings& settings, const QString& settingsGroupPathParent, QNetworkAccessManager& network, cweqt::Manager& web, QObject *parent = nullptr);
