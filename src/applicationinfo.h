...
#define APP_INFO_PRODUCTVERSION_MINOR 32
#define APP_INFO_PRODUCTVERSION_PATCH 3
...
#define APP_INFO_LEGALCOPYRIGHT_STR         "\251 " APP_INFO_COMPANYNAME_STR ", " APP_INFO_LEGALCOPYRIGHT_YEARS_STR
#define APP_INFO_LEGALCOPYRIGHT_STR_U       "\u00A9 " APP_INFO_COMPANYNAME_STR ", " APP_INFO_LEGALCOPYRIGHT_YEARS_STR
